...
module.exports = class Subscriber extends EventEmitter 
{
    ...
    allowEvents, params, extraHeaders }) 
  {
    ...
    // To prevent duplicate un-subscribe sending.
    ...
    {
      let contact = `Contact: <sip:${this._params.from_uri.user}@${Utils.createRandomToken(12)}.invalid;transport=ws>`;

      contact += `;+sip.instance="<urn:uuid:${this._ua.configuration.instance_id}>"`;
