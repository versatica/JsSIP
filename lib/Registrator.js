...
class Registrator {
  ...
  register() {
    ...
    let extraHeaders = this.extraHeaders.slice();
    ...
    let request_sender = new RequestSender(this, this.ua);
      ...
      switch(true) {
        ...
        case /^2[0-9]{2}$/.test(response.status_code):
          ...
          this.registrationTimer = setTimeout(() => {
            ...
            if (this.ua.listeners('registrationExpiring').length === 0) {
              this.register();
            } else {
              this.ua.emit('registrationExpiring');
            }
          }, (expires * 1000) - 5000);
  ...
  registrationFailure(response, cause) {
    this.registering = false;
