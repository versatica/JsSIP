      ...
      onReceiveResponse : (response) =>
      {
        ...
        switch (true)
        {
          ...
          case /^2[0-9]{2}$/.test(response.status_code):
            ...
            if (!contacts)
            {
              this.debug('no Contact header in response to REGISTER, response ignored');
              break;
            }
            ...
            if (!contact)
            {
              this.debug('no Contact header pointing to us, response ignored');
              break;
            }
          ...
          case /^423$/.test(response.status_code):
            ...
            { // This response MUST contain a Min-Expires header field
              this.debug('423 response received for REGISTER without Min-Expires');
