...
module.exports = class Registrator
{
  constructor(ua, transport)
  {
    ...
    this._extraHeaders = [];
	// Add  Authorization: Bearer  if auth token ware supply in configuration
	if(ua.configuration.auth)  this._extraHeaders.push('Authorization: Bearer '+ua.configuration.auth)
