...
function rfc3261_8_2_2_2()
{
  ...
  if (message.method === JsSIP_C.INVITE)
  {
    ...
    {
      for (const transaction in ua.transactions.ist)
      {
        if (Object.prototype.hasOwnProperty.call(ua.transactions.ist, transaction))
        {
          tr = ua.transactions.ist[transaction];
  ...
  // TODO: we should reply the last response.
  else if (ua.transactions.nist[message.via_branch])
  {
    return false;
  }
  ...
  {
    for (const transaction in ua.transactions.nist)
    {
      if (Object.prototype.hasOwnProperty.call(ua.transactions.nist, transaction))
      {
        tr = ua.transactions.nist[transaction];
        if (tr.request.from_tag === fromTag &&
            tr.request.call_id === call_id &&
            tr.request.cseq === cseq)
        {
