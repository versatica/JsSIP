...
module.exports = class DTMF extends EventEmitter
{
  constructor(session)
  {
    ...
    const debugPrefix = session._ua.configuration.debug_prefix;
    
    this.debug = require('debug')(`${debugPrefix}JsSIP:RTCSession:DTMF`);
    this.debugerror = require('debug')(`${debugPrefix}JsSIP:ERROR:RTCSession:DTMF`);
