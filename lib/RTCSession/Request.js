...
module.exports = class Request
{
  ...
  onRequestTimeout()
  {
    ...
    if (this._eventHandlers.onRequestTimeout) { this._eventHandlers.onRequestTimeout(); }
  }

  onTransportError()
  {
    debugerror('onTransportError');
    if (this._eventHandlers.onTransportError) { this._eventHandlers.onTransportError(); }
  }

  onDialogError()
  {
    debugerror('onDialogError');
    if (this._eventHandlers.onDialogError) { this._eventHandlers.onDialogError(); }
  }
};
