...
module.exports = class RTCSession extends EventEmitter
{
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then((stream) =>
      {
        ...
        if (stream)
        {
          return this._addMediaStream(stream, 'getTracks', { sendEncodings: options.sendEncodings, onAddedTransceiver: options.onAddedTransceiver });
        }
      })
  ...
  _addMediaStream(stream, action, { sendEncodings, onAddedTransceiver })
  {
  ...
  _addOrReplacePresentationMediaStream(stream, { sendEncodings, onAddedTransceiver })
  {
    ...
    {
      return this._addMediaStream(stream, 'getVideoTracks', { sendEncodings, onAddedTransceiver });
    }
  }
  ...
  _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream, { sendEncodings, onAddedTransceiver })
  {
    ...
    Promise.resolve()
      ...
      .then((stream) =>
      {
        ...
        if (stream)
        {
          return this._addMediaStream(stream, 'getTracks', { sendEncodings, onAddedTransceiver });
        }
