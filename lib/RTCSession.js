...
function receiveRefer(request) {
  ...
  this.emit('refer', {
    request: request,
    accept(initCallback, options) { accept.call(self, initCallback, options); },
    reject() { reject.call(self); }
  });
}
...
function receiveReplaces(request) {
  ...
  this.emit('replaces', {
    request: request,
    accept(initCallback) { accept.call(self, initCallback); },
    reject() { reject.call(self); }
  });
}
