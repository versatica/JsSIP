...
module.exports = class RTCSession extends EventEmitter
{
  ...
  _createLocalDescription(type, constraints, readyCalled = false)
  {
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        ...
        if (connection.iceGatheringState === 'complete' || readyCalled)
        {
          this._rtcReady = true;
        ...
        return new Promise((resolve) =>
        {
          ...
          const ready = () =>
          {
            ...
            // resolve(e.sdp);
            resolve(this._createLocalDescription(type, constraints, true)); // gotta recreate the SDP otherwise it doesnt get updated with candidates
          };
