...
module.exports = class RTCSession extends EventEmitter
{
  ...
  startPresentation(stream, extraHeaders, isNeedReinvite=true)
  {
    debug('presentation()');
    ...
    return new Promise((resolve, reject) =>
    {
      ...
      this._sendInfoInner(extraHeaders)
        .then(() => 
        {
  ...
  stopPresentation(stream, extraHeaders)
  {
    debug('presentation()');
