...
module.exports = class RTCSession extends EventEmitter
{
  ...
  connect(target, options = {}, initCallback)
  {
    ...
    if (!WebRTCGlobals.RTCPeerConnection)
    {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        else if (mediaConstraints.audio || mediaConstraints.video)
        {
          ...
          return WebRTCGlobals.getUserMedia(mediaConstraints)
            .catch((error) =>
            {
              if (this._status === C.STATUS_TERMINATED)
              {
  ...
  {
    this._connection = new (WebRTCGlobals.RTCPeerConnection)(pcConfig, rtcConstraints);
