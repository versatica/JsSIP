...
module.exports = class RTCSession extends EventEmitter
{
    ...
    else
    {
      ...
      switch (request.method)
      {
        ...
        case JsSIP_C.NOTIFY:
          ...
          const e = { event: request.event, request: request, taken: false };
  ...
  _createRTCConnection(pcConfig, rtcConstraints)
  {
    ...
    this._connection.addEventListener('iceconnectionstatechange', () =>
    {
      ...
      if (this._ua._chrome_rtp_timeout_fix !== undefined && navigator.webkitGetUserMedia && state === 'disconnected'){
        let timeout = this._ua._chrome_rtp_timeout_fix;
        ...
        let checking = ()=>{
          if (this._connection.iceConnectionState === 'disconnected') {
            ...
            debug('AC: Chrome RTP timeout fix: iceConnectionState=' + this._connection.iceConnectionState);
          }
        };
        checking();
      }
