...
}) =>
{
  ...
  // Установим параметры отправки (битрейт/деградация), если запрошены.
...
module.exports = class RTCSession extends EventEmitter
{
  ...
  _addOrReplacePresentationMediaStream(stream, { directionAudio, directionVideo, degradationPreference, sendEncodings, onAddedTransceiver })
  {
