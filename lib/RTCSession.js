/* globals RTCSessionDescription: false */
...
module.exports = class RTCSession extends EventEmitter
{
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        else if (mediaConstraints.audio || mediaConstraints.video)
        {
          ...
          return WebRTCGlobals.getInstance().getUserMedia(mediaConstraints)
            .catch((error) =>
            {
              if (this._status === C.STATUS_TERMINATED)
              {
  ...
  _createRTCConnection(pcConfig, rtcConstraints)
  {
    ...
    this._connection = new (WebRTCGlobals.getInstance().RTCPeerConnection)(pcConfig, rtcConstraints);
