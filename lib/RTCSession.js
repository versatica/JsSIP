...
RTCSession.prototype.connect = function(target, options, initCallback) {
  ...
  var event, requestParams,
    ...
    mediaConstraints = options.mediaConstraints || {audio: { mandatory : { googEchoCancellation: true, googEchoCancellation2: true, googAutoGainControl: true, googNoiseSuppression: true, googHighpassFilter: true, googTypingNoiseDetection: true } }, video: true},
