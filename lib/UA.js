...
class UA extends events.EventEmitter
{
  ...
  stop()
  {
    ...
    for (const session in this.sessions)
    {
      if (Object.prototype.hasOwnProperty.call(this.sessions, session))
      {
        ...
        try { this.sessions[session].terminate(); }
        catch (error) {}
      }
    }
    ...
    {
      if (Object.prototype.hasOwnProperty.call(this.applicants, applicant))
        try { this.applicants[applicant].close(); }
        catch (error) {}
    }
  ...
  receiveRequest(request)
  {
    ...
    {
      const transaction = new Transactions.InviteServerTransaction(request, this);
    }
    else if (method !== JsSIP_C.ACK && method !== JsSIP_C.CANCEL)
    {
      const transaction = new Transactions.NonInviteServerTransaction(request, this);
    }
...
function onTransportDisconnect(data)
{
  ...
  {
    for (const id in this.transactions[type])
    {
      if (Object.prototype.hasOwnProperty.call(this.transactions[type], id))
      {
