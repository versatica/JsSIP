...
module.exports = class UA extends EventEmitter
{
  ...
  receiveRequest(request)
  {
    ...
    else if (method === JsSIP_C.INFO)
    {
      ...
      if (contentType &&
        this._configuration.content_type_share_state_regexp &&
        contentType.match(this._configuration.content_type_share_state_regexp)
      )
      {
        ...
        contentType &&
        this._configuration.content_type_enter_room_regexp &&
        contentType.match(this._configuration.content_type_enter_room_regexp)
      )
      {
  ...
  _loadConfig(configuration)
  {
    ...
    const writable_parameters = [
      'authorization_user', 'password', 'realm', 'ha1', 'authorization_jwt', 'display_name', 'register', 'content_type_share_state_regexp', 'content_type_enter_room_regexp'
    ];
