...
const UA = module.exports = class UA extends EventEmitter
{
  ...
  constructor(configuration)
  {
    ...
    this._configuration = Object.assign({}, settings);
  ...
  _loadConfig(configuration)
  {
    ...
    for (const parameter in UA.configuration_check.mandatory)
    {
    ...
    for (const parameter in UA.configuration_check.optional)
    {
      if (configuration.hasOwnProperty(parameter))
      {
        const value = configuration[parameter];
    ...
    if (this._configuration.sockets && Array.isArray(this._configuration.sockets))
    {
      sockets = sockets.concat(this._configuration.sockets);
    }
    ...
    try
    {
      ...
      delete this._configuration.connection_recovery_max_interval;
      delete this._configuration.connection_recovery_min_interval;
