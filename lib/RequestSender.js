...
module.exports = class RequestSender
{
  ...
  constructor(ua, request, eventHandlers, config2=null)
  {
    this._ua = ua;
  ...
  _receiveResponse(response)
  {
    ...
    */
    if ((status_code === 401 || status_code === 407) &&
        (this._config2 !== null || this._ua.configuration.password !== null || this._ua.configuration.ha1 !== null))
    {
      ...
      if (!this._challenged || (!this._staled && challenge.stale === true))
      {
        if (!this._auth)
        {
			let cnf = this._config2 ? this._config2 : this._ua.configuration;
        ...
        // Update ha1 and realm in the UA or in alternative config.
		    if( !this._config2 )
		    {
