...
class NonInviteClientTransaction extends EventEmitter
{
  constructor(request_sender, request, transport)
  {
    ...
    via += ` ${request_sender._ua.configuration.via_host};branch=${this.id}`;

    this.request.setHeader('via', via);

    this.request_sender._ua.newTransaction(this);
  }
  ...
  onTransportError()
  {
    ...
    this.request_sender._ua.destroyTransaction(this);
