...
class NonInviteClientTransaction extends EventEmitter
{
  constructor(ua, transport, request, eventHandlers)
  {
    ...
    this.debug = require('debug')(`${debugPrefix}JsSIP:NonInviteClientTransaction`);
...
class InviteClientTransaction extends EventEmitter
{
  constructor(ua, transport, request, eventHandlers)
  {
    ...
    this.debug = require('debug')(`${debugPrefix}JsSIP:InviteClientTransaction`);
...
class AckClientTransaction extends EventEmitter
{
  constructor(ua, transport, request, eventHandlers)
  {
    ...
    this.debug = require('debug')(`${debugPrefix}JsSIP:AckClientTransaction`);
...
class NonInviteServerTransaction extends EventEmitter
{
  constructor(ua, transport, request)
  {
    ...
    this.debug = require('debug')(`${debugPrefix}JsSIP:NonInviteServerTransaction`);
...
class InviteServerTransaction extends EventEmitter
{
  constructor(ua, transport, request)
  {
    ...
    this.debug = require('debug')(`${debugPrefix}JsSIP:InviteServerTransaction`);
