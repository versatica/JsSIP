...
const debugnict = require('./JsSIPDebug')('JsSIP:NonInviteClientTransaction');
const debugict = require('./JsSIPDebug')('JsSIP:InviteClientTransaction');
const debugact = require('./JsSIPDebug')('JsSIP:AckClientTransaction');
const debugnist = require('./JsSIPDebug')('JsSIP:NonInviteServerTransaction');
const debugist = require('./JsSIPDebug')('JsSIP:InviteServerTransaction');
