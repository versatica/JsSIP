...
module.exports = class Transport
{
  constructor(sockets, recovery_options = C.recovery_options)
  {
    ...
    if (!recovery_options.min_interval || recovery_options.min_interval < 0)
    {
      this.recovery_options.min_interval = C.recovery_options.min_interval;
    }
    if (!recovery_options.max_interval || recovery_options.max_interval < 0)
    {
      this.recovery_options.max_interval = C.recovery_options.max_interval;
    }
